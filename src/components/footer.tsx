...
const Footer = () => {
  return (
    <footer className='border-[1px] border-gray-400 mt-16  py-10'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-24'>
  
        <div className='space-y-4'>
            <img  className='w-[300px] h-[220px]' src='/profile.svg'></img>
        ...
        <div className='flex flex-col font-bold items-start space-y-4'>
          ...
          <button className='bg-blue-500 round h-[70px] w-[100px] hover:bg-blue-600 text-white px-4 py-2 rounded'>
            Support Us
          </button>
        </div>
